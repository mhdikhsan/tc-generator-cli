...
def separate_functions(file_path):
    ...
    with open(file_path, "r") as file:
        for line in file:
            ...
            # Check if the line starts with the "def" keyword
...
for file_name in py_files:
    ...
    for function in function_list:
        ...
        try:
            ...
            continue
        cfg_visual = cfg.build_visual(f'cfgvisual {id}', 'json', build_keys=False, calls=False)
        cfg.build_visual(f'cfg_visual/cfgvisual {id}', 'png', build_keys=False, calls=False)
        ...
        try:
            ...
            for obj in data['objects']:
                cfg[obj['_gvid']] = Node(obj['name'], obj['_gvid'], obj['label'].replace("\\l", "\n"))
